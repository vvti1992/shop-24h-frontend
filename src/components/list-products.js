...
import ProductListComponent from "./content/content/ProductListComponent";
...
function FilterProduct({data, setListProduct}) {
    var LIST_PRODUCT = JSON.parse(LIST_PRODUCE_JSON);
    const [filterList, setFilterList] = useState([]);
    const [tempList, setTempList] = useState([]);
   useEffect(()=>{
    setListProduct(LIST_PRODUCT);
